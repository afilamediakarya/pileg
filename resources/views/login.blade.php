	...
	<body id="kt_body" class="bg-white">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
				<!--begin::Aside-->
				<div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative" style="background-color: #1D4ED8;">
					<!--begin::Wrapper-->
						...
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
							...
							<form class="form w-100"  id="kt_sign_in_form" method="post" action="{{route('login')}}">
								...
								<div class="text-center mb-10">
									<!--begin::Title-->
									<h1 class="text-dark mb-3">Sign In to Avila</h1>
									<!--end::Title-->
								...
								<div class="fv-row mb-10">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input class="form-control form-control-lg form-control-solid" type="text" id="username" name="username"  required value="{{old('username')}}" />
									<!--end::Input-->
								</div>
								<!--end::Input group-->
								<!--begin::Input group-->
